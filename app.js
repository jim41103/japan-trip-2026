...
const JP_PHRASES = [
  ...
  { cat:'food',      jp:'温めますか？',                      rom:'Atatamemasu ka?',                      zh:'（店員問）需要幫您加熱嗎？' },
  { cat:'food',      jp:'お箸／スプーンをお付けしますか？',   rom:'Ohashi / supuun o otsuke shimasu ka?', zh:'（店員問）需要附筷子／湯匙嗎？' },
  { cat:'food',      jp:'スプーンをください',                rom:'Supuun o kudasai',                     zh:'請給我湯匙' },
  { cat:'food',      jp:'別々に会計できますか？',            rom:'Betsubetsu ni kaikei dekimasu ka?',    zh:'可以分開結帳嗎？' },
  { cat:'food',      jp:'辛くしないでください',              rom:'Karaku shinaide kudasai',              zh:'請不要辣' },
  { cat:'food',      jp:'辛さを控えめにしてください',        rom:'Karasa o hikaeme ni shite kudasai',    zh:'請幫我降低辣度' },
  { cat:'food',      jp:'中国語のメニューはありますか？',    rom:'Chuugokugo no menyuu wa arimasu ka?',  zh:'有中文菜單嗎？' },
  { cat:'food',      jp:'これは何人前ですか？',              rom:'Kore wa naninin mae desu ka?',         zh:'這是幾人份？' },
  { cat:'food',      jp:'お水をください',                    rom:'Omizu o kudasai',                      zh:'請給我水' },
  { cat:'food',      jp:'おすすめは何ですか？',              rom:'Osusume wa nan desu ka?',              zh:'有推薦的餐點嗎？' },
  { cat:'food',      jp:'免税でお願いします',                rom:'Menzei de onegaishimasu',              zh:'請幫我用免稅方式結帳' },
  { cat:'food',      jp:'袋に入れてください',                rom:'Fukuro ni irete kudasai',              zh:'請幫我裝袋' },
  { cat:'food',      jp:'お持ち帰りできますか？',            rom:'Omochikaeri dekimasu ka?',             zh:'可以外帶嗎？' },
  { cat:'stay',      jp:'レイトチェックアウトできますか？',  rom:'Reito chekkuauto dekimasu ka?',        zh:'可以延後退房嗎？' },
  { cat:'stay',      jp:'Wi-Fiのパスワードを教えてください', rom:'Wi-Fi no pasuwaado o oshiete kudasai', zh:'請告訴我Wifi密碼' },
  { cat:'stay',      jp:'タトゥー（刺青）があっても入浴できますか？', rom:'Tatuu (shisei) ga atte mo nyuuyoku dekimasu ka?', zh:'有刺青可以泡湯嗎？' },
  { cat:'stay',      jp:'荷物を預かってもらえますか？',      rom:'Nimotsu o azukatte moraemasu ka?',     zh:'可以幫我寄放行李嗎？' },
  { cat:'stay',      jp:'チェックインは何時からですか？',    rom:'Chekku in wa nanji kara desu ka?',     zh:'幾點可以開始辦理入住？' },
  ...
  { cat:'transport', jp:'このバスは〇〇に行きますか？',      rom:'Kono basu wa 〇〇 ni ikimasu ka?',      zh:'這班公車有到〇〇嗎？' },
  { cat:'transport', jp:'切符を払い戻しできますか？',        rom:'Kippu o haraimodoshi dekimasu ka?',    zh:'車票可以退票嗎？' },
  { cat:'transport', jp:'ここに荷物を置いてもいいですか？',  rom:'Koko ni nimotsu o oite mo ii desu ka?', zh:'行李可以放這裡嗎？' },
  { cat:'transport', jp:'何番線ですか？',                    rom:'Nanbansen desu ka?',                   zh:'是幾號月台？' },
  { cat:'transport', jp:'次の電車は何時ですか？',            rom:'Tsugi no densha wa nanji desu ka?',    zh:'下一班電車是幾點？' },
  ...
  { cat:'emergency', jp:'近くに薬局はありますか？',          rom:'Chikaku ni yakkyoku wa arimasu ka?',   zh:'附近有藥局嗎？' },
  { cat:'emergency', jp:'頭が痛いです',                      rom:'Atama ga itai desu',                   zh:'我頭痛' },
  { cat:'emergency', jp:'お腹が痛いです',                    rom:'Onaka ga itai desu',                   zh:'我肚子痛' },
  { cat:'emergency', jp:'熱があります',                      rom:'Netsu ga arimasu',                     zh:'我發燒了' },
  { cat:'emergency', jp:'〇〇にアレルギーがあります',        rom:'〇〇 ni arerugii ga arimasu',           zh:'我對〇〇過敏（〇〇代入食物/藥物名）' },
  { cat:'emergency', jp:'気分が悪いです',                    rom:'Kibun ga warui desu',                  zh:'我不舒服' },
  { cat:'emergency', jp:'救急車を呼んでください',            rom:'Kyuukyuusha o yonde kudasai',          zh:'請幫我叫救護車' },
];
